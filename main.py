...
# Headers for sending second post request
POSTING_HEADERS = {
    "Accept":"*/*",
    "Accept-Encoding":"gzip, deflate, br",
    "Accept-Language":"en-US,en;",
...
def scrape_questcdn(url, num_postings):
    #  Making request for top posting
    ...
    if response.status_code == 200:
        ...
        for i in range(num_postings):
            ...
            if posting_response.status_code == 200:
                # Parsing HTML data from response
                ...
                # Printing the data extracted from URL
                print("="*50)
